...
struct DummyData {
    ...
    static public let dummyPost = Post(userId: "1", caption: "My first caption.", date: Date(), url: "post")
    ...
    static public func GetFeed() -> [Post] {
        var list = [Post]()
        for i in 1...5 {
            var newPost = Post(userId: "\(i)", caption: "My first caption.", date: Date(), url: "post")
